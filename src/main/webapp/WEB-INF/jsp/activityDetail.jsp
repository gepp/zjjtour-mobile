	...
	<body>
		...
		<div class="mui-content">
			<div class="mui-content-padded">
				...
				<h5 class="mui-h5">活动开始时间：${startTime }</h5>
				<h5 class="mui-h5">活动截止时间：${endTime }</h5>
				<h5 class="mui-h5">报名人数：${activity.usercount }</h5>
				<h5 class="mui-h5">活动状态：
				...
				<p>活动介绍：${activity.abstractContent }</p>
				${activity.content }
 			</div>
		</div>
