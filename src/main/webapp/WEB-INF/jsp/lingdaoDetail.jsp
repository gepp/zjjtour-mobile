...
<html>
	...
	<div id="header"></div>
		...
		<div class="mui-content">
			...
			<!--重要活动-->
			<h5>重要活动<span class="more" onclick="gotoMore('ZYHD')">更多>></span></h5>
			<ul class="mui-table-view mui-table-view-chevron">
				<c:forEach var="item" items="${ZYHDList }">
				...
				<c:if test="${fn:length(ZYHDList)<=0}">
				 <li>
				 	暂无
				 </li>
				 </c:if>
			...
			<h5>重要讲话<span class="more" onclick="gotoMore('ZYJH')">更多>></span></h5>
			<ul class="mui-table-view mui-table-view-chevron">
				<c:forEach var="item" items="${ZYJHList }">
				<li class="mui-table-view-cell mui-media"  onclick="jumpDetail('${item.id}')">
					<a class="mui-navigate-right">
						<img class="mui-media-object mui-pull-left" src="${item.smallimg }">
						<div class="mui-media-body">
				 ...
				 <c:if test="${fn:length(ZYJHList)<=0}">
				 <li>
				 	暂无
				 </li>
				 </c:if>
			</ul> 
			 <h5>媒体报道<span class="more" onclick="gotoMore('MTBD')">更多>></span></h5>
			<ul class="mui-table-view mui-table-view-chevron">
				<c:forEach var="item" items="${MTBDList }">
				<li class="mui-table-view-cell mui-media"  onclick="jumpDetail('${item.id}')">
					<a class="mui-navigate-right">
						<img class="mui-media-object mui-pull-left" src="${item.smallimg }">
						<div class="mui-media-body">
				...
				<c:if test="${fn:length(MTBDList)<=0}">
				 <li>
				 	暂无
				 </li>
				 </c:if>
