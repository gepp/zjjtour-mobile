...
<html>
	...
	<body>
		<header class="mui-bar mui-bar-nav">
			...
			<h1 class="mui-title">${shipin.name }详情</h1>
			<a id="menu" class="mui-action-menu mui-icon mui-icon-bars mui-pull-right" style="margin: 0 -10px 0 0;" href="#middlePopover"></a>
		</header>
		<div class="mui-content">
			 
			
			<h4 class="mui-h4">${newsShipin.title }</h4>
			<fmt:formatDate value="${newsShipin.ctime }" pattern="yyyy-MM-dd" var="ctime"/>
			<h5 class="mui-h5">发布时间：${ctime }</h5>
			
			  
			<video id="myVideo" autoplay="autoplay" controls="controls" loop="loop" style="width:100%">
			    <!-- 提供多种格式的视频文件，以便浏览器从中播放自身支持的视频文件 -->
			    <source src="${newsShipin.videoUrl }" ></source>
				您的浏览器不支持video标签。
			</video>
