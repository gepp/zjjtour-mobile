...
<html>
	<div class="footer-center">
			<ul class="mui-table-view mui-grid-view mui-grid-9">
				<li class="mui-table-view-cell mui-media mui-col-xs-6 mui-col-sm-3" onclick="window.location.href='${contextpath}/tousu.htm'">
				...
				<li class="mui-table-view-cell mui-media mui-col-xs-6 mui-col-sm-3" onclick="window.location.href='${contextpath}/chengxin.htm'">
					<a  href="javascript:void(0)" >
